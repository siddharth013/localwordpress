       ...
       if ( !class_exists('WooCommerce') || (class_exists('WooCommerce') && !is_shop() ) ) {
            ...
            wp_localize_script( 'reviewx-js', 'rx_ajax_data',
                array(
                    ...
                    'please_accept_agreement'   => ! empty(get_theme_mod('reviewx_media_upload_compliance_validation') ) ? get_theme_mod('reviewx_media_upload_compliance_validation') : __('Please accept the media upload compliance', 'reviewx'),
    ...
    **/    
    public function reviewx_anonymouse_field( $submit_button, $args ) {
        ...
        if( get_post_type() == 'product' ) {
            ...
            $button 			= '';
            $echo 				= '';
            if( !\ReviewX_Helper::is_pro() && get_option('_rx_option_allow_media_compliance') == 1 && get_option('_rx_option_allow_img') == 1 ) {
            $echo .='<div class="review_media_compliance">';
                $echo .='<label class="review_media_compliance_label">';  
                    ...
                    $echo .= !empty(get_theme_mod('reviewx_media_compliance') ) ? get_theme_mod('reviewx_media_compliance') : esc_html__( 'Allow using your uploaded attachment by this website.', 'reviewx' );
            ...
            if( !\ReviewX_Helper::is_pro() && $allow_media_compliance == 1 && $allow_img == 1 ) {
            $echo .='<div class="review_media_compliance">';
                $echo .='<label class="review_media_compliance_label">';    
                    $echo .='<input type="checkbox" name="rx_allow_media_compliance" id="rx_allow_media_compliance" value=1>';                
                    $echo .='<span class="review_media_compliance_icon"></span>';
