...
function reviewx_builder_args() {
    return array(
        ...
        'tabnumber'    => true,
        'layout'       => 'horizontal',
        'tabs'         => apply_filters( 'rx_builder_tabs', array(
            'source_tab' => array(
                    ...
                    'allow_utilities' => array(
                        ...
                        'fields' => array(                            
                            ...
                            'allow_media_compliance' => array(
                                'heading' => __('Allow Media Upload Compliance', 'reviewx'),
                                'label' => __('Allow shop owner to display media upload compliance', 'reviewx'),
                                'type'  => 'switcher',
                            ),                            
