    ...
    ?>
        <script>
            jQuery(document).ready(function() {
                let masonryGrid = jQuery(".betterdocs-category-grid.masonry");
                let columnPerGrid = jQuery(".betterdocs-category-grid.masonry").attr('data-column');
                let masonryItem = jQuery(".betterdocs-category-grid.masonry .el-betterdocs-category-grid-post");
                let grid_space = jQuery(".betterdocs-category-grid.masonry").attr('data-column-space');
                let total_margin = columnPerGrid * grid_space;
