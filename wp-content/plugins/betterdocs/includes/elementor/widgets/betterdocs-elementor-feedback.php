    ...
    public function feedback_form () {
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .betterdocs-modalwindow .modal-content h2' => 'color: {{VALUE}};',
                ]
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .betterdocs-modalwindow .modal-content h2'
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .betterdocs-modalwindow .modal-content h2' => 'text-align: {{VALUE}};',
                ],
            ]
        );
