...
class BetterDocs {
	...
	public function __construct() {
        ...
        // add_action( 'save_post_docs', array( $this, 'flush_rules_on_save_posts' ), 10 , 3 );
	}
	...
	*/
    ...
    /**
     * Flushes rewrite rules if docs post is updated
     *
     * @since    1.7.2
     * @access   private
     */
    private function flush_rules_on_save_posts($post_id) {
