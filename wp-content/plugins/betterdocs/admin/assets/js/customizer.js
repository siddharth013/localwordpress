...
( function( $ ) {
    ...
    wp.customize( 'betterdocs_doc_page_list_icon_font_size', function( value ) {
        value.bind( function( to ) {
            ...
            $( '.betterdocs-categories-wrap.single-kb .docs-item-container li svg' ).css( 'min-width', to + 'px' );
        } );
    });
    ...
    wp.customize( 'betterdocs_single_doc_feedback_title_font_size', function( value ) {
        value.bind( function( to ) {
            $( '.betterdocs-entry-footer .feedback-form .modal-content h2' ).css( 'font-size', to + 'px' );
        } );
    });

    wp.customize( 'betterdocs_single_doc_feedback_title_color', function( value ) {
        value.bind( function( to ) {
            $( '.betterdocs-entry-footer .feedback-form .modal-content h2' ).css( 'color', to );
        } );
    });
    ...
    wp.customize( 'betterdocs_sidebar_title_color', function( value ) {
        value.bind( function( to ) {
            $( '.betterdocs-sidebar-content.betterdocs-category-sidebar .docs-cat-title-inner h3,.betterdocs-sidebar-content.betterdocs-category-sidebar .docs-cat-title-inner .cat-list-arrow-down' ).css( 'color', to );
        } );
    });
    
    wp.customize( 'betterdocs_sidebar_active_title_color', function( value ) {
        value.bind( function( to ) {
            $( '.betterdocs-sidebar-content.betterdocs-category-sidebar .docs-single-cat-wrap .active-title .docs-cat-title-inner h3,.betterdocs-sidebar-content.betterdocs-category-sidebar .active-title .docs-cat-title-inner h3,.betterdocs-category-wraper .betterdocs-full-sidebar-left .docs-cat-title-wrap::after').css( 'color', to );
        } );
    });
    
    wp.customize( 'betterdocs_sidebar_title_font_size', function( value ) {
        value.bind( function( to ) {
            $( '.betterdocs-sidebar-content.betterdocs-category-sidebar .docs-cat-title-inner h3' ).css( 'font-size', to + 'px' );
        } );
    });
